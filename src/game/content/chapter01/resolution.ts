...
export const resolutionNodes: Record<string, StoryNode> = {
  ...
  TX_PREP_01: { id: "TX_PREP_01", blocks: [d("강수진", "“PBG 검체는 이미 나갔습니다.”"), d("플레이어", "“헤민 준비해주세요.”"), d("강수진", "“네.”"), p("유발 가능 약물을 중단한다. 충분한 탄수화물 공급을 시작한다. 전해질과 신경학적 상태를 반복 평가한다.")], onEnter: [setFlag("hemin_started"), setFlag("disease_progression_halted"), { type: "value", key: "treatment_timing", value: "appropriate" }], choices: go("WAIT_002") },
  ...
  PBG_RESULT: { id: "PBG_RESULT", title: "PBG / ALA 결과", blocks: [d("강수진", "“결과 나왔습니다.”"), s("Urine PBG: markedly elevated\nUrine ALA: elevated"), thought("reasoning", "급성 간성 포르피린증."), thought("mechanism", "아직 급성 간헐성 포르피린증이라고 단정하지 마."), thought("reasoning", "알아.\n아형은 나중이다."), thought("decision", "환자는 지금이다.")], onEnter: [setFlag("pbg_positive"), setFlag("acute_hepatic_porphyria_confirmed"), { type: "test", patientId: "harin", testId: "urine_pbg_ala", status: "positive" }, { type: "value", key: "diagnosis_outcome", value: "appropriate" }], choices: [
  ...
  TX_HEMIN: { id: "TX_HEMIN", blocks: [d("플레이어", "“헤민 시작합니다.”")], onEnter: [setFlag("hemin_started"), setFlag("disease_progression_halted"), { type: "value", key: "treatment_timing", value: "delayed" }], choices: go("DISCLOSE_001") },
