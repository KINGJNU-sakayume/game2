...
export const hospitalChapter: ChapterDefinition = {
  ...
  nodes: {
    ...
    ER_001: { id: "ER_001", title: "19:55 응급실", presentation: { imageKey: "erInitial", timeLabel: "19:55", location: "응급실 07" }, onEnter: [{ type: "setTime", value: 1195 }], blocks: [
    ...
    ER_006: { id: "ER_006", presentation: { timeLabel: "21:46" }, blocks: [d("강수진", "“선생님, 다시 전해질 나왔습니다.”"), s("Na 124"), d("플레이어", "“128에서?”"), d("강수진", "“네.”"), d("강수진", "“그리고 화장실 갔다 오다가 주저앉았어요.”")], onEnter: [{ type: "setTime", value: 1306 }, { type: "disease", patientId: "harin", stage: "progressing" }], choices: go("ER_007") },
