...
export const deteriorationNodes: Record<string, StoryNode> = {
  DET_001: { id: "DET_001", title: "23:31", presentation: { timeLabel: "23:31" }, onEnter: [{ type: "advanceToTime", value: 1411 }, { type: "value", key: "sodium", value: 121 }, { type: "disease", patientId: "harin", stage: "progressing" }], blocks: [
  ...
  DET_003: { id: "DET_003", blocks: [p("근위부 하지 근력이 명확히 감소했다.\n상지에도 약화가 시작된다.\n감각은 비교적 유지된다.\n호흡은 아직 안정적이다."), d("강수진", "“혈압도 계속 높습니다.”"), s("HR 126\nBP 174/106\nNa 121")], onEnter: [clue("progressive_motor_neuropathy"), clue("autonomic_instability")], choices: go("CASE_002") },
  CASE_002: { id: "CASE_002", title: "Case Conference", presentation: { mode: "cinematic" }, blocks: [
    ...
    thought("mechanism", "헴."),
  ], onEnter: [setFlag("acute_hepatic_porphyria_available"), { type: "diagnosis", patientId: "harin", diagnosisId: "acute_hepatic_porphyria" }], choices: go("CASE_003") },
};
